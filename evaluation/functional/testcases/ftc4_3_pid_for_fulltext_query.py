...
# field matches fulltext query. For the resulting dataset a PID is issued. Subsequently the dataset is modified
# but the persistently identified subset should remain unchanged
...
# STEPS
results = []
pid = ckan.client.action.issue_pid(resource_id=resource_id, q='Aus')
...
logging.info("'tc4_3' successfully executed!")
